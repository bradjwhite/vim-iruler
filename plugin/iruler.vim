"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Author: This Vimrc is based off of: amix the lucky stiff:
" see http://amix.dk - amix@amix.dk
" Blog_post: 
...
"Modified: by Matt Cauthorn for the vim iRuler project."

"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" => General
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" MC - I like zenburn, peaksea and desert. Change to whatever
" you like...note that it'll affect your highlighing too.
"colorscheme zenburn
colorscheme default
set encoding=utf8
try
...
" => Files and backups
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Turn backup on/off here if you want.
" iRules are usually stored on BigIP.
"set nobackup
"set nowb
"set noswapfile
...
" => Text, tab and indent related
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" MC - I disabled the two below for python. think it may cause issues.
set expandtab
set shiftwidth=4
set tabstop=4
"Debug...MC"
...
" MC - I disabled the two below for python. think it may cause issues.
set ai "Auto indent
" I think the setting below is windows specific, so commenting out.
"set si "Smart indet
set wrap "Wrap lines

" Commented from the origial author's vimrc. Haven't tested it.
...
" => Moving around, tabs and buffers
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" MC - below disabled to allow for folding.
